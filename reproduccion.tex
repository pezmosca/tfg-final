...
Se descargará en el home para simplificar la reproducción.

\subsection{Instalación de las herramientas}
La herramienta será instalada en el home para simplificar la reproducción, suponiendo que la herramienta está en el home y suponiendo la versión 4.1.1-2.11:
...
\subsection{Instalación de las herramientas}
La herramienta será instalada en el home para simplificar la reproducción, suponiendo que las herramientas están en el home y suponiendo la versión 6.3.0 de todas ellas:
\begin{lstlisting}[language=Bash]
